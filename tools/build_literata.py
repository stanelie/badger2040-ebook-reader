...
a different size or a different font.
    ...
    python tools/build_literata.py 13 108   # size=13px, threshold=108 (9 lines/page)
...
SIZE = int(sys.argv[1]) if len(sys.argv) > 1 else 13  # 13px -> box_h 15, paired with 14px pitch (9 lines)
