...
# Imported as "reader" by the code.py shim, but epub_xtract, convert_ui,
# coverimg and factory all reach back for the reader through __main__ - which,
# with a shim, is the shim. Registering here keeps every one of those lookups
# working, and has to happen before anything can import them.
